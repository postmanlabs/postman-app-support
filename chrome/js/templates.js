...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  else { stack1 = (depth0 && depth0.expires); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</td>\n    <td>";
  if (stack1 = helpers.httpOnly) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.httpOnly); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</td>\n    <td>";
  if (stack1 = helpers.secure) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = (depth0 && depth0.secure); stack1 = typeof stack1 === functionType ? stack1.call(depth0, {hash:{},data:data}) : stack1; }
  buffer += escapeExpression(stack1)
    + "</td>\n</tr>\n";
  return buffer;
  });
...
function program1(depth0,data) {
  ...
  buffer += escapeExpression(((stack1 = helpers.link_to_hyperlink || (depth0 && depth0.link_to_hyperlink)),stack1 ? stack1.call(depth0, (depth0 && depth0.value), options) : helperMissing.call(depth0, "link_to_hyperlink", (depth0 && depth0.value), options)))
    + "\n        ";
  return buffer;
  }
...
function program3(depth0,data) {
  ...
  stack1 = helpers['if'].call(depth0, (depth0 && depth0.isLink), {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    </div>\n</li>";
  return buffer;
  });
