...
var chromeHeaders = [
    //Standard headers
    { label: "Accept", category: "Standard HTTP Headers" },
    { label: "Accept-Charset", category: "Standard HTTP Headers" },
    { label: "Accept-Encoding", category: "Standard HTTP Headers" },
    { label: "Accept-Language", category: "Standard HTTP Headers" },
    { label: "Authorization", category: "Standard HTTP Headers" },
    { label: "Cache-Control", category: "Standard HTTP Headers" },
    { label: "Connection", category: "Standard HTTP Headers" },
    { label: "Cookie", category: "Standard HTTP Headers" },
    { label: "Content-Length", category: "Standard HTTP Headers" },
    { label: "Content-MD5", category: "Standard HTTP Headers" },
    { label: "Content-Type", category: "Standard HTTP Headers" },
    { label: "Date", category: "Standard HTTP Headers" },
    { label: "Expect", category: "Standard HTTP Headers" },
    { label: "From", category: "Standard HTTP Headers" },
    { label: "Host", category: "Standard HTTP Headers" },
    { label: "If-Match", category: "Standard HTTP Headers" },
    { label: "If-Modified-Since", category: "Standard HTTP Headers" },
    { label: "If-None-Match", category: "Standard HTTP Headers" },
    { label: "If-Range", category: "Standard HTTP Headers" },
    { label: "If-Unmodified-Since", category: "Standard HTTP Headers" },
    { label: "Max-Forwards", category: "Standard HTTP Headers" },
    { label: "Pragma", category: "Standard HTTP Headers" },
    { label: "Proxy-Authorization", category: "Standard HTTP Headers" },
    { label: "Range", category: "Standard HTTP Headers" },
    { label: "Referer", category: "Standard HTTP Headers" },
    { label: "TE", category: "Standard HTTP Headers" },
    { label: "Upgrade", category: "Standard HTTP Headers" },
    { label: "User-Agent", category: "Standard HTTP Headers" },
    { label: "Via", category: "Standard HTTP Headers" },
    { label: "Warning", category: "Standard HTTP Headers" },
    //Non standard headers
    { label: "X-Requested-With", category: "Standard HTTP Headers" },
    { label: "X-Do-Not-Track", category: "Standard HTTP Headers" },
    { label: "DNT", category: "Standard HTTP Headers" }
];